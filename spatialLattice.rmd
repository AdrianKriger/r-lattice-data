...
All the previous function accepted a `zero.policy = TRUE` and / or  `na.action = na.exclude` which allowed us to work around not having a complete data set (`NaN` and `NA` values). Geographically Weighted Regression (GWR) _**does not**_ accept `NaN` and `NA` values. 
