...
A regression model gives us an idea of how different factors are associated with the target variable (`CRIME`) in the suburbs of Cape Town, South Africa and their interaction.
...
Smaller `p-values < 0` generally  indicate significance while `p-values > 0` typically indicate no significance.
